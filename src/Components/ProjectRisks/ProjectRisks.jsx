export default function ProjectRisks() {
  ...
  return (
    <div className="overflow-auto text-[0.6rem] text-gray-300 h-[300px]">
      <table className="w-full border border-gray-700 text-center">
        <thead className="bg-gray-800 text-gray-300 text-xs">
          <tr>
            <th className="border border-gray-700 py-1">الرقم</th>
            <th className="border border-gray-700 py-1">المخاطر</th>
            <th className="border border-gray-700 py-1">الحل</th>
          </tr>
        </thead>
        <tbody>
          {risks.map((r) => (
            <tr key={r.id} className="hover:bg-gray-800/60">
              <td className="border border-gray-700 px-1 py-1">{r.id}</td>
              <td className="border border-gray-700 px-1 py-1">{r.risk}</td>
              <td className="border border-gray-700 px-1 py-1">{r.solution}</td>
            </tr>
          ))}
        </tbody>
      </table>
